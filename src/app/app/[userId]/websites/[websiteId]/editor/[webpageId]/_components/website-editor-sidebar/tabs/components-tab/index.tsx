...
import NavbarPlaceholder from "./nav-bar-placeholder";
...
const ComponentsTab = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      <AccordionItem value="Components" className="px-6 py-0 border-y-[1px]">
        <AccordionTrigger className="!no-underline">Pre-built</AccordionTrigger>
        <AccordionContent className="flex flex-wrap gap-2 ">
          {elements
